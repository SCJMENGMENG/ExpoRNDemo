...
export default function IndexATabPage() {
  return (
    <Tab.Navigator>
      <Tab.Screen name="TabOne" component={HomeScreen} options={{ title: 'Tab1' }} />
      <Tab.Screen name="TabTwo" component={TabTwoScreen} options={{ title: 'Tab2' }} />
    </Tab.Navigator>
  );
}